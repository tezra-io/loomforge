...
export function buildPrompt(context: WorkflowStepContext): string {
  ...
  sections.push(
    ...
    "1. Read the repo's AGENTS.md or CLAUDE.md for conventions and constraints.",
    "2. Run `git log --oneline -20` to understand recent changes and branch state.",
    "3. Explore the codebase to understand architecture, module boundaries, and",
